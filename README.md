...
Sensors: Ultrasonic sensor, Rain sensor, Turbidity sensor
...
ESP32 processes the sensor inputs

Automated control logic triggers gate actions
...
To provide early flood warnings
